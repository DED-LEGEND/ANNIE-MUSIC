    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("DxAbouT")
                await self.one.join_chat("DxFRIENDS")
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("DxAbouT")
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("DxAbouT")
                await self.three.join_chat("DxFRIENDS")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("DxAbouT")
                await self.four.join_chat("DX_INFO")
                await self.four.join_chat("YARANA_TG")
                await self.four.join_chat("DxFRIENDS")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("DxFRIENDS")
                await self.five.join_chat("DxAbouT")
